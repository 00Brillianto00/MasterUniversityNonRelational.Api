...
namespace MasterUniversityNonRelational.Api.Interfaces
{
    public interface IEnrollmentService
    {
        ...
        Task<List<Enrollment>> TestEnrollmentUpdate(int testCases, List<UniversityData> universities, List<Lecturer> lecturers, List<Courses> courses, List<Student> students, int totalNeededDoc);
