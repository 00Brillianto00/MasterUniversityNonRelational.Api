...
{
    public class PerformanceTestGetService : IPerformanceTestGetService
    {
        private readonly IMongoCollection<TestResultData> _testResult;

        public PerformanceTestGetService(IMongoClient mongoDBClient, IDatabaseSettings databaseSettings)
        {

            var database = mongoDBClient.GetDatabase(databaseSettings.DatabaseName);
            databaseSettings.CollectionName = "PerformanceTestGet";
