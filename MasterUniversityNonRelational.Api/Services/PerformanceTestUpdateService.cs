...
{
    public class PerformanceTestUpdateService : IPerformanceTestUpdateService
    {
        private readonly IMongoCollection<TestResultData> _testResult;

        public PerformanceTestUpdateService(IMongoClient mongoDBClient, IDatabaseSettings databaseSettings)
        {

            var database = mongoDBClient.GetDatabase(databaseSettings.DatabaseName);
            databaseSettings.CollectionName = "PerformanceTestUpdate";
